...
const Navbar = () => {
    ...
    const user = useSelector((state) => state.user); //READING A STATE WE HAVE CREATED USING THE CREATESLICE IN REDUX-TOOLKIT 
    ...
    return (
        <FlexBetween padding="1rem 6%" backgroundColor={alt}>
          ...
          {isNonMobileScreens ? (
            ...
            <IconButton
              onClick={() => setIsMobileMenuToggled(!isMobileMenuToggled)} //really nice way to put this
            >
              <Menu />
            </IconButton>
          )}
